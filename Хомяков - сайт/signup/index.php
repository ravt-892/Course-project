...
?>
<div class="login_main">Регистрация пользователя</div>
<form action="" method="POST" class="form">
	...
	<input type="password" name="password_2" placeholder="Повторите пароль" value="<?php echo @$data['password_2']; ?>">

	<strong><?php captcha_show(); ?></strong>
	<input type="text" name="captcha" >

	<button type="submit" name="do_signup" class="btn_signup">Регистрация</button>
</form>
<a href="../../login" class="href_login">Войти</a>
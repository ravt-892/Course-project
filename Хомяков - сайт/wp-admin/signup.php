...
<form action="/wp-admin/signup.php" method="POST" class="form_signup">
	...
	<button type="submit" name="do_signup" class="btn_signup_form">Регистрация</button>
</form>
<a href="index.php" class="btn_back">На главную панель администратора</a>